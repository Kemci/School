...
<%!
	...
	public void jspInit() {
        getServletContext().log("InitServlet init e-Store :)");
    	...
    	try {
			...
			if (!rs.next()) {
				...
				// Load the user data
				c.prepareStatement("INSERT INTO Users (name, type, password) VALUES ('user1@e-store.com', 'USER', '" + getRndPassword() + "')").execute();
				c.prepareStatement("INSERT INTO Users (name, type, password) VALUES ('admin@e-store.com', 'ADMIN', '" + getRndPassword() + "')").execute();
				c.prepareStatement("INSERT INTO Users (name, type, password, currentbasketid) VALUES ('test@e-store.com', 'USER', 'password', 1)").execute(); // Ok, so this one is easy:)
				...
				c.prepareStatement("INSERT INTO Score (task, description, status) VALUES ('LOGIN_TEST', 'Login as test@e-store.com', 0)").execute();
				c.prepareStatement("INSERT INTO Score (task, description, status) VALUES ('LOGIN_USER1', 'Login as user1@e-store.com', 0)").execute();
				c.prepareStatement("INSERT INTO Score (task, description, status) VALUES ('LOGIN_ADMIN', 'Login as admin@e-store.com', 0)").execute();
